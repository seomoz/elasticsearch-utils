...
INCLUDES = {
    ...
    'linux2': ['%(linux2)s/include' %(JDK),
               '%(linux2)s/include/linux' %(JDK), '/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.9.x86_64/include/',
               '/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.9.x86_64/',
               '/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.9.x86_64/include/linux/'],
...
LFLAGS = {
    ...
    'linux2/i686': ['-L%(linux2)s/jre/lib/i386' %(JDK), '-ljava',
                    '-L%(linux2)s/jre/lib/i386/client' %(JDK), '-ljvm',
                    '-Wl,-rpath=%(linux2)s/jre/lib/i386:%(linux2)s/jre/lib/i386/client' %(JDK)],
    'linux2/x86_64': ['-L%(linux2)s/jre/lib/amd64' %(JDK), '-ljava', '-L/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.9.x86_64/jre/lib/amd64/server/',
                      '-L/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.9.x86_64/jre/lib/amd64/',
